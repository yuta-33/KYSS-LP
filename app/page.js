...
const faqItems = [
  ...
  {
    q: "U-18部門に19歳以上のメンバーを入れてもいいですか？",
    a: "できません。部門はチーム内で最も年齢が高いメンバーを基準に判定します。19歳以上のメンバーが1人でもいる場合は、U-30部門でエントリーしてください。18歳以下のメンバーのみのチームはU-18部門にエントリーできます。"
  },
  {
    q: "外部のメンターに相談してもいいですか？",
    a: "問題ありません。ビジネスの世界では周囲の力を借りることも大切なスキルです。ただし、発表・資料作成はメンバー自身で行ってください。"
  },
  {
    q: "生成AIを使ってもいいですか？",
    a: "利用可能です。資料作成やアイデアの検討に活用してください。"
  }
];
